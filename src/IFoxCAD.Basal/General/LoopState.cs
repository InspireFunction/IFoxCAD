...
public class LoopState
{
    ...
    public bool IsExceptional => (_LoopStateFlags & PLS_EXCEPTIONAL) == PLS_EXCEPTIONAL;
    public bool IsBreak => (_LoopStateFlags & PLS_BROKEN) == PLS_BROKEN;
    public bool IsStop => (_LoopStateFlags & PLS_STOPPED) == PLS_STOPPED;
    public bool IsCancel => (_LoopStateFlags & PLS_CANCELED) == PLS_CANCELED;

    public void Exceptional()
    {
        if ((_LoopStateFlags & PLS_EXCEPTIONAL) != PLS_EXCEPTIONAL)
            _LoopStateFlags |= PLS_EXCEPTIONAL;
    }
    public void Break() => _LoopStateFlags = PLS_BROKEN;
    public void Stop() => _LoopStateFlags = PLS_STOPPED;
    public void Cancel() => _LoopStateFlags = PLS_CANCELED;
}
#line default