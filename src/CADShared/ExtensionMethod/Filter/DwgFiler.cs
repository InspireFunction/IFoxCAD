...
*/
// DYH 2025-01-21 取消序列化相关代码，因为无法打上json转换器，不想让ifox再多引一个json包
// 如有此类需求自己继承并实现即可
// #if false
// [JsonConverter(typeof(ObjectIdConverter))]
// #endif
[Serializable]
public class IFoxDwgFiler : DwgFiler
{
    public IFoxDwgFiler(FilerType filerType = FilerType.CopyFiler)
    {
        m_FilerType = filerType;
    }

    public long m_Position = 0;
    public FilerType m_FilerType;
    public ErrorStatus m_FilerStatus = ErrorStatus.OK;
    public List<IntPtr> AddressList = new();
    public int AddressListPt;
    public List<byte[]> BinaryChunkList = new();
    public int BinaryChunkListPt;
    public List<bool> BooleanList = new();
    ...
    public List<Handle> HandleList = new();

    public int HandleListPt;

    //[NonSerialized]
    //[ScriptIgnore]
    public List<ObjectId> HardOwnershipIdList = new();

    public int HardOwnershipIdListPt;

    //[NonSerialized]
    //[ScriptIgnore]
    public List<ObjectId> HardPointerIdList = new();
    public int HardPointerIdListPt;
    public List<short> Int16List = new();
    public int Int16ListPt;
    public List<int> Int32List = new();
    public int Int32ListPt;

    public List<long> Int64List = new();
    public int Int64ListPt;

    public List<Point2d> Point2dList = new();
    public int Point2dListPt;
    public List<Point3d> Point3dList = new();
    public int Point3dListPt;
    public List<Scale3d> Scale3dList = new();

    public int Scale3dListPt;

    //[NonSerialized]
    //[ScriptIgnore]
    public List<ObjectId> SoftOwnershipIdList = new();

    public int SoftOwnershipIdListPt;

    //[NonSerialized]
    //[ScriptIgnore]
    public List<ObjectId> SoftPointerIdList = new();
    public int SoftPointerIdListPt;
    public List<string> StringList = new();
    public int StringListPt;
    public List<ushort> Uint16List = new();
    public int uint16ListPt;
    public List<uint> Uint32List = new();
    public int uint32ListPt;

    public List<ulong> Uint64List = new();
    public int uint64ListPt;

    public List<Vector2d> Vector2dList = new();
    public int Vector2dListPt;
    public List<Vector3d> Vector3dList = new();
    public int Vector3dListPt;
