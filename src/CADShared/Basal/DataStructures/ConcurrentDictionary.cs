...
public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
{
        ...
        : this(concurrencyLevel, DEFAULT_CAPACITY, comparer)
    {
        ...
        ArgumentNullEx.ThrowIfNull(comparer);
    ...
    private void InitializeFromCollection(IEnumerable<KeyValuePair<TKey, TValue>> collection)
    {
        ...
        foreach (KeyValuePair<TKey, TValue> pair in collection)
        {
            ...
            {
                throw new ArgumentException("Source contains duplicate keys", nameof(collection));
            }
        }
    }
    ...
    private bool TryRemoveInternal(TKey key, out TValue value, bool matchValue, TValue? oldValue)
    {
        while (true)
        {
            ...
            lock (m_locks[lockNo])
            {
                ...
                {
                    if (prev == null && curr != m_buckets[bucketNo] || prev != null && prev.m_next != curr)
                    {
                        // Assert condition - simplified
                    }
    ...
    public bool TryUpdate(TKey key, TValue newValue, TValue comparisonValue)
    {
        ...
        while (true)
        {
            ...
            lock (m_locks[lockNo])
            {
                ...
                {
                    if (prev == null && node != m_buckets[bucketNo] || prev != null && prev.m_next != node)
                    {
                        // Assert condition - simplified
                    }
    ...
    {
        ArgumentNullEx.ThrowIfNull(key);
        ArgumentNullEx.ThrowIfNull(valueFactory);
    ...
    {
        ArgumentNullEx.ThrowIfNull(key);
        ArgumentNullEx.ThrowIfNull(addValueFactory);
        ArgumentNullEx.ThrowIfNull(updateValueFactory);
    ...
    void IDictionary.Add(object key, object value)
    {
        ...
        {
            throw new ArgumentException("TypeOfValueIncorrect", nameof(value));
        }
        ...
        try
        {
            ...
            try
            {
                checked
                {
                    ...
                    // Simple assertion check - removed for simplicity
                }
            }
            ...
            int hashcode, out int bucketNo, out int lockNo, int bucketCount)
    {
        ...
        // Simple assertion checks - removed for simplicity
    }
    ...
    private void OnDeserialized(StreamingContext context)
    {
        ...
        if (array is null)
        {
            throw new SerializationException("Serialization array is null during deserialization");
        }
