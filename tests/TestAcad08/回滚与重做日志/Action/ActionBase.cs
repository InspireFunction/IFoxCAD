...
public abstract class ActionBase : IAction
{
    ...
    public static IAction? Deserialize(string json)
    {
        ...
        try
        {
            ...
            var s = MyJson.DeserializeObject<ActionBase>(json);
...
/// 实体动作基类
/// </summary>
public abstract class EntityAction : ActionBase
{
    /// <summary>
    /// id
    /// </summary>
...
public class ModifyEntityAction : EntityAction
{
    ...
    public ModifyEntityAction(ObjectId entityId, Dictionary<string, (object, object)> changes) : base(entityId)
    {
    ...
    public override void Execute()
    {
        ...
        using var obj = tr.GetObject(DBObjectId, OpenMode.ForWrite, true, true);
        if (obj != null)
            ApplyFields(obj, FieldChanges, true);
    }
